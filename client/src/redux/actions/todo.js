...
export const getTodo = (id) => async (dispatch) => {
  try {
    ...
    const res = await axios.get(`/api/v1/todos/${id}`);
...
export const addTodo = (formData) => async (dispatch) => {
  ...
  try {
    ...
    const res = await axios.post('/api/v1/todos', formData, config);
...
export const updateTodo = (formData, id) => async (dispatch) => {
  try {
    ...
    const res = await axios.put(`/api/v1/todos/${id}`, formData, config);
...
export const toggleCompleteTodo = (id) => async (dispatch) => {
  try {
    ...
    const res = await axios.put(`/api/v1/todos/complete/${id}`, config);
    dispatch({
